...
document.getElementById('meu-botao').addEventListener('click', function () {
	// aqui é onde você deve colocar o código que será executado ao clicar no botão
	// por exemplo, você pode chamar uma função que esteja definida em outro arquivo JavaScript
	migrar();
});
